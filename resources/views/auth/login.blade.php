    ...
    <div class="w-full max-w-6xl">
        <div class="bg-white rounded-[32px] shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="p-8 sm:p-12">
                <div class="mb-8">
                    <h1 class="text-3xl font-extrabold text-[#1F2937] tracking-tight">Login</h1>
                    <p class="text-gray-500 mt-2">Silakan masuk sebagai Admin untuk mengelola sistem</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('password.request') }}" class="text-sm text-[#4A90E2] hover:underline">Lupa kata sandi saya</a>
                    </div>
                    ...
                    @if (config('services.google.enabled', false))
                        ...
                        <!-- Google Button -->
                        <a href="{{ route('oauth.google.redirect') }}" class="w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-xl py-3 font-semibold shadow-sm transition flex items-center justify-center gap-2">
